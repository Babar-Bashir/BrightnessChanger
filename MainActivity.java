...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BrightnessWriter.getRootAccess(getApplicationContext());
        ...
        brightnessSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if(!BrightnessWriter.writeBrightness(BrightnessValueContainer.brightnessValue)) {
                    Toast.makeText(getApplicationContext(), "Cannot change brightness, have you granted su permission?", Toast.LENGTH_SHORT).show();
                    System.exit(1);
                }
            }
        });
    ...
    public void onNewIntent(Intent intent) {
        if(intent.getAction().equals(Actions.ACTION_CLOSE_APPLICATION)) {
            closeApplication();
            System.out.println("RECEIVED INTENT FROM MAIN");
        }
    }*/
    ...
    private void setButtonsOnClickAction() {
        ...
        changeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BrightnessWriter.writeBrightness(BrightnessValueContainer.brightnessValue);
    ...
    public static int getCurrentBrightnessValue() {
        return BrightnessValueContainer.brightnessValue;
    }
